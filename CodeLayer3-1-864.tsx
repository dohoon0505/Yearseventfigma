  ...
  return (
    <div className="w-full relative">
      <input
        ...
        className={
          `w-full h-[55px] pl-[15px] text-base outline-none transition-all duration-300 ease-in-out pr-[40px] ${
            disabled ? 'cursor-not-allowed pointer-events-none' : ''
          } ${isCompleted ? "font-['Pretendard-Regular']" : "font-['Pretendard-Light']"}`
        }
        style={{
          fontFamily: disabled ? 'Pretendard-Light' : isCompleted ? 'Pretendard-Regular' : 'Pretendard-Light',
          paddingRight: isCompleted ? '70px' : '40px',
          color: disabled ? defaultTextColor : isCompleted ? completedTextColor : isTyping ? typingTextColor : isHovered ? hoverTextColor : defaultTextColor,
          backgroundColor: disabled ? '#FDFDFD' : isCompleted ? completedBgColor : isTyping ? typingBgColor : isHovered ? hoverBgColor : defaultBgColor,
      ...
      >
        {showPassword ? (
          ...
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 12C1 12 5 4 12 4C19 4 23 12 23 12C23 12 19 20 12 20C5 20 1 12 1 12Z" stroke="#222222" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <span className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_63_8599)">
              ...
              <path d="M10.0001 1.66669L12.1889 3.26337L14.8983 3.25821L15.7306 5.83656L17.9255 7.4249L17.0834 10L17.9255 12.5751L15.7306 14.1635L14.8983 16.7418L12.1889 16.7367L10.0001 18.3334L7.81118 16.7367L5.10185 16.7418L4.26951 14.1635L2.07458 12.5751L2.91672 10L2.07458 7.4249L4.26951 5.83656L5.10185 3.25821L7.81118 3.26337L10.0001 1.66669Z" fill="#85C83E" />
              <path d="M7.08337 10L9.16671 12.0834L13.3334 7.91669" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
