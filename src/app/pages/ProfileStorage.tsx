...
function ProfileSection() {
  ...
  const columns: Column<Profile>[] = [
    ...
    { label: "수정", width: "52px", align: "center", render: (r) => <button onClick={() => openEdit(r)} className="p-1.5 rounded hover:bg-[#e8edff] transition-colors"><Pencil size={14} className="text-[#4169e1]" /></button> },
    { label: "삭제", width: "52px", align: "center", render: (r) => <button onClick={() => setDeleteTarget(r)} className="p-1.5 rounded hover:bg-[#ffeded] transition-colors"><Trash2 size={14} className="text-[#f44336]" /></button> },
  ];
