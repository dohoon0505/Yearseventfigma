...
/* 삭제 확인(체크 게이트) 다이얼로그는 openDialog 위에 세워진 것이라 dialog.js 가 소유한다 —
   주문뿐 아니라 거래처(admin-clients)·프로필 저장공간도 쓴다. 기존 호출부 호환으로 재수출만 한다. */
export { openDeleteConfirm } from "./dialog.js";
