/* ============================================================
   ...
   accountId / role / lastLogin = 구 시스템 '사용자 리스트(101)'에서 이관.
...
export const STAFF = [
  ...
  { id: "s1", name: "최고관리자", dept: "시스템",     phone: "010-7615-2699", notify: true,  accountId: "admin",     role: "최고관리자", lastLogin: "2026-09-14 20:48", system: true },
  { id: "s2", name: "개발",       dept: "시스템",     phone: "010-8714-1540", notify: false, accountId: "dev",       role: "최고관리자", lastLogin: "2026-08-24 14:14", system: true },
  { id: "s3", name: "메이플라워", dept: "운영",       phone: "",              notify: false, accountId: "mayflower", role: "담당자",     lastLogin: "2026-09-14 21:52", system: true },
  /* 주문 처리 담당자 — 로그인 계정 없이 배정·알림만 받는다(구 시스템에 대응 없음). */
  { id: "s4", name: "김총무", dept: "총무팀",     phone: "010-1234-5678", notify: true,  accountId: "", role: "담당자", lastLogin: "" },
  { id: "s5", name: "박사원", dept: "영업1팀",    phone: "010-2345-6789", notify: true,  accountId: "", role: "담당자", lastLogin: "" },
  { id: "s6", name: "이대리", dept: "물류팀",     phone: "010-3456-7890", notify: false, accountId: "", role: "담당자", lastLogin: "" },
  { id: "s7", name: "최과장", dept: "고객지원팀", phone: "010-4567-8901", notify: true,  accountId: "", role: "담당자", lastLogin: "" },
  { id: "s8", name: "오임찬", dept: "영업2팀",    phone: "010-5678-9012", notify: true,  accountId: "", role: "담당자", lastLogin: "" },
];
